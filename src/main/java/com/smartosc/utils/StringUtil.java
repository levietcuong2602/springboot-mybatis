...
public class StringUtil {
    ...
    /**
     * Determine whether the object is a positive integer
     *
     * @param value
     * @return
     */
    ...
    /**
     * Check barcode length is 4 to 40 digits
     *
     * @param value
     * @return
     */
    ...
    /**
     * Determine whether the object is a number (including decimals)
     *
     * @param str
     * @return
     */
    public static boolean isPositiveBigDecimal(String str) {
        ...
        if (str.indexOf(".") > 0) {// determine whether there is a decimal point
            if (str.indexOf(".") == str.lastIndexOf(".") && str.split("\\.").length == 2) { // Determine whether there is only one decimal point
